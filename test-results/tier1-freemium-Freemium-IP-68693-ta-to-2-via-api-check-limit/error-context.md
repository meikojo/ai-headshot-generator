...
- Name: tier1\freemium.spec.ts >> Freemium IP & Fingerprinting >> Submitting 1 successful tool usage reduces the remaining quota to 2 via /api/check-limit
- Location: e2e\tier1\freemium.spec.ts:22:7
