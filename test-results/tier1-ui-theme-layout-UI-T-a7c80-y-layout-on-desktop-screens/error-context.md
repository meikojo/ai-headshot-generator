...
- Name: tier1\ui-theme-layout.spec.ts >> UI Theme & Layout >> All tool pages strictly follow a 40% interaction/upload zone and 60% result display layout on desktop screens
- Location: e2e\tier1\ui-theme-layout.spec.ts:32:7
