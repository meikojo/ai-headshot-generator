...
- Name: tier1\replace-background.spec.ts >> Replace Background Tool >> User can upload a source image and provide a text prompt describing the new background
- Location: e2e\tier1\replace-background.spec.ts:16:7
