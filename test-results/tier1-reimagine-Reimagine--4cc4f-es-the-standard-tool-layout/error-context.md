...
- Name: tier1\reimagine.spec.ts >> Reimagine Tool >> User navigates to /tools/reimagine and sees the standard tool layout
- Location: e2e\tier1\reimagine.spec.ts:10:7
