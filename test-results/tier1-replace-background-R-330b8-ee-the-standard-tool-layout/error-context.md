...
- Name: tier1\replace-background.spec.ts >> Replace Background Tool >> User can navigate to /tools/replace-background and see the standard tool layout
- Location: e2e\tier1\replace-background.spec.ts:10:7
