...
- Name: tier1\upscale.spec.ts >> Upscale Tool >> User accesses /tools/upscale and the upload zone is visible and functional
- Location: e2e\tier1\upscale.spec.ts:10:7
