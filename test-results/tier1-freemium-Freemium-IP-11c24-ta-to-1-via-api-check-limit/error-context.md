...
- Name: tier1\freemium.spec.ts >> Freemium IP & Fingerprinting >> Submitting 2 successful tool usages reduces the remaining quota to 1 via /api/check-limit
- Location: e2e\tier1\freemium.spec.ts:30:7
