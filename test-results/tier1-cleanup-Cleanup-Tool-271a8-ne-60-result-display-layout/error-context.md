...
- Name: tier1\cleanup.spec.ts >> Cleanup Tool >> User can navigate to /tools/cleanup and view the 40% upload zone / 60% result display layout
- Location: e2e\tier1\cleanup.spec.ts:10:7
