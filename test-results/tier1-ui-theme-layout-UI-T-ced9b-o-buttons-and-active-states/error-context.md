...
- Name: tier1\ui-theme-layout.spec.ts >> UI Theme & Layout >> Electric blue (#4f8ef7) and purple (#a855f7) accents are applied to buttons and active states
- Location: e2e\tier1\ui-theme-layout.spec.ts:11:7
