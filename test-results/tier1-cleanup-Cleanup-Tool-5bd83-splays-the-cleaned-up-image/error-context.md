...
- Name: tier1\cleanup.spec.ts >> Cleanup Tool >> The tool gracefully handles the server response and displays the cleaned-up image
- Location: e2e\tier1\cleanup.spec.ts:30:7
