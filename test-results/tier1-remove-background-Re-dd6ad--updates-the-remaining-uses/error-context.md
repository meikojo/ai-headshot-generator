...
- Name: tier1\remove-background.spec.ts >> Remove Background Tool >> Successfully processing an image calls /api/increment-usage and updates the remaining uses
- Location: e2e\tier1\remove-background.spec.ts:44:7
