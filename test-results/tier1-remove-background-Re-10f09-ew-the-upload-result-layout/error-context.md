...
- Name: tier1\remove-background.spec.ts >> Remove Background Tool >> User can successfully navigate to /tools/remove-background and view the upload/result layout
- Location: e2e\tier1\remove-background.spec.ts:10:7
