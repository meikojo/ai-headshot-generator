...
- Name: tier1\text-to-image.spec.ts >> Text to Image Tool >> Submitting a text prompt (e.g., "A futuristic city skyline") initiates image generation
- Location: e2e\tier1\text-to-image.spec.ts:11:7
