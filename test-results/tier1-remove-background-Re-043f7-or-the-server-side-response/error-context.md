...
- Name: tier1\remove-background.spec.ts >> Remove Background Tool >> The UI displays a clear loading indicator while waiting for the server-side response
- Location: e2e\tier1\remove-background.spec.ts:27:7
