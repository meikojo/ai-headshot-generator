...
- Name: tier1\replace-background.spec.ts >> Replace Background Tool >> The new image with the requested background is displayed in the result area
- Location: e2e\tier1\replace-background.spec.ts:38:7
