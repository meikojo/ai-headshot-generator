...
- Name: tier1\text-to-image.spec.ts >> Text to Image Tool >> Free usage limit is properly updated via /api/increment-usage after generation
- Location: e2e\tier1\text-to-image.spec.ts:38:7
