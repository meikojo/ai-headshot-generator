...
- Name: tier1\freemium.spec.ts >> Freemium IP & Fingerprinting >> A new user with a fresh IP and fingerprint is granted exactly 3 free uses
- Location: e2e\tier1\freemium.spec.ts:10:7
