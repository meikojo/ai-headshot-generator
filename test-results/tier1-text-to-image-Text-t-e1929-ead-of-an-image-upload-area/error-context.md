...
- Name: tier1\text-to-image.spec.ts >> Text to Image Tool >> The /tools/text-to-image page loads with a text input prompt area instead of an image upload area
- Location: e2e\tier1\text-to-image.spec.ts:4:7
