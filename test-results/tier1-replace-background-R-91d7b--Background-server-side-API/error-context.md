...
- Name: tier1\replace-background.spec.ts >> Replace Background Tool >> The submission successfully calls the Replace Background server-side API
- Location: e2e\tier1\replace-background.spec.ts:26:7
