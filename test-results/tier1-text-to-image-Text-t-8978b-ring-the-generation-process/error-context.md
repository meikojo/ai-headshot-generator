...
- Name: tier1\text-to-image.spec.ts >> Text to Image Tool >> Loading indicators are shown during the generation process
- Location: e2e\tier1\text-to-image.spec.ts:22:7
