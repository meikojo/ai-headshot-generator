...
- Name: tier1\remove-background.spec.ts >> Remove Background Tool >> Uploading a valid PNG image successfully triggers the background removal API call
- Location: e2e\tier1\remove-background.spec.ts:16:7
