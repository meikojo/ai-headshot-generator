...
- Name: tier1\stripe-monetization.spec.ts >> Stripe Monetization & Webhook >> A paid user (with is_paid=true) returning to the app no longer sees the free usage badge
- Location: e2e\tier1\stripe-monetization.spec.ts:63:7
